	...
	<form method="post">
		...
		<table class="tableForm">
			<tr>
				...
				<td><input name="name" class="easyui-validatebox" data-options="required:true,missingMessage:'请填写菜单名称'" style="width: 155px;" />
				</td>
			...
			<tr>
				<th>权限描述</th>
				<td colspan="3"><input name="description" style="width:98%;" />
				</td>
			</tr>
			<tr>
				<th>上级权限</th>
