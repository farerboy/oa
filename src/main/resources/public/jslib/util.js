...
var util = $.extend({}, util);/* 定义全局对象，类似于命名空间或包的作用 */
...
$.extend($.fn.datagrid.defaults.editors, {
	combocheckboxtree : {
		...
		setValue : function(target, value) {
			$(target).combotree('setValues', util.getList(value));
		},
	...
	multiplecombobox : {
		...
		setValue : function(target, value) {
			$(target).combobox('setValues', util.getList(value));
		},
		resize : function(target, width) {
 ...
 *            回调方法
 */
util.messagerConfirm = function(title, msg, fn) {
 ...
 * @requires jQuery,EasyUI
 */
util.messagerShow = function(options) {
 ...
 * @requires jQuery,EasyUI
 */
util.messagerAlert = function(title, msg, icon, fn) {
 ...
 * 增加命名空间功能
 * 
 * 使用方法：util.ns('jQuery.bbb.ccc','jQuery.eee.fff');
 */
util.ns = function() {
	var o = {}, d;
...
util.UUID = function() {
	return (util.random4() + util.random4() + "-" + util.random4() + "-" + util.random4() + "-" + util.random4() + "-" + util.random4() + util.random4() + util.random4());
};
 ...
 * @requires jQuery
 * 
 * 判断浏览器是否是IE并且版本小于8(jQuery1.9以后这种写法)
 * 
 * @returns true/false
 */
util.isLessThanIe8 = function() {
